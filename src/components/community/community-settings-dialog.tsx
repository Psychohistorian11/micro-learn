...
import { IconLoader2, IconUpload, IconX, IconSettings, IconTrash } from "@tabler/icons-react";
import { uploadFile } from "@/lib/storage";
import { CommunityDTO, CommunityUpdateDTO } from "@/interface/community";
import { updateCommunity, deleteCommunity } from "@/lib/services/community-service";
            ...
            <DialogContent className="sm:max-w-[600px] max-h-[90vh] overflow-y-auto">
                ...
                <div className="space-y-6">
                    ...
                    <form onSubmit={onSubmit} className="space-y-4">
                        ...
                        <div>
                            <Label>Imagen de la comunidad</Label>
                            <div
                                className={`flex-1 flex flex-col items-center justify-center
                  border-2 border-dashed rounded-xl cursor-pointer transition overflow-hidden p-3 mt-2
                  ${image
                        ...
                        <DialogFooter className="gap-2">
                            ...
                            <Button type="submit" className="bg-persian-green" disabled={isSubmitting || isUploading}>
